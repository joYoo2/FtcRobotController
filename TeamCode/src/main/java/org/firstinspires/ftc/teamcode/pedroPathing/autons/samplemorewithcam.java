...
@Autonomous(name = "Samplewithcam", group = "Pedro")
public class samplemorewithcam extends OpMode {
    ...
    int sampleCounter = 0;
    double xCoordinate = 70;
    double yCoordinate = 70;
    double angle = 0;
        ...
        switch (pathState) {
            ...
            case 11:
                ...
                if(!follower.isBusy()) {
                    ...
                    if(pathTimer.getElapsedTimeSeconds() > 5.2){
                        actions.clawVertical();
    ...
    public void init_loop() {
        ...
        if(posePressed){
            ...
            telemetry.addData("Max Y: 96 Min Y: 83", "Only up to the middle");
