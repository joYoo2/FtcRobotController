...
@Autonomous(name = "Sample with Specimen PEDRO", group = "Pedro")
public class samplespecimen extends OpMode {
    ...
    private final Pose chamberPose = new Pose(38, 81, Math.toRadians(0));
    ...
    public void buildPaths() {
        ...
        grabPickup1 = follower.pathBuilder()
                .addPath(new BezierLine(new Point(chamberPose), new Point(pickup1Pose)))
